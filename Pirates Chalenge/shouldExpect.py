...
# Select UF and click the Search button
choice = Select(browser.find_element_by_name("UF"))
print('What is the UF that you want to check?')
UF = input().upper()
if UF in allUFs:
    ...
    print("\nThe UF was not found. Please check the list below and try again:\n")
    print(allUFs)
    UF = input().upper()
    if UF in allUFs:
        chooseUF = choice.select_by_value(UF)
        ...
        print("I'm sorry but this UF wasn't found. Bye!")
        exit()
